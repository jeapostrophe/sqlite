...
; sqlite3_commit_hook
(define-sqlite sqlite3_open (_fun (filename) :: (filename : _bytes) (db : (_ptr o _sqlite3_database)) -> (result : _int) -> (values db result)))
; sqlite3_open16
(define-sqlite sqlite3_errcode (_fun _sqlite3_database -> _int))
(define-sqlite sqlite3_errmsg (_fun _sqlite3_database -> _string))
; sqlite3_errmsg16
(define-sqlite sqlite3_prepare_v2 (_fun (db zsql) ::
                                        ...
                                        (result : _int) -> (values statement result tail)))
; sqlite3_prepare16
...
(provide/contract
 [status? (any/c . c-> . boolean?)]
 [sqlite3_open (bytes? . c-> . (values sqlite3_database? status?))]
 [sqlite3_close (sqlite3_database? . c-> . status?)]
 [sqlite3_last_insert_rowid (sqlite3_database? . c-> . exact-nonnegative-integer?)]
 [sqlite3_changes (sqlite3_database? . c-> . exact-nonnegative-integer?)]
 [sqlite3_total_changes (sqlite3_database? . c-> . exact-nonnegative-integer?)]
 [sqlite3_prepare_v2 (sqlite3_database? string? . c-> . (values (or/c sqlite3_statement? false/c) status? string?))]
 [sqlite3_errmsg (sqlite3_database? . c-> . string?)]
 [sqlite3_step (sqlite3_statement? . c-> . status?)]
 [sqlite3_bind_parameter_count (sqlite3_statement? . c-> . exact-nonnegative-integer?)]
 [sqlite3_bind_int64 (sqlite3_statement? exact-nonnegative-integer? integer? . c-> . status?)]
 [sqlite3_bind_double (sqlite3_statement? exact-nonnegative-integer? number? . c-> . status?)]
 [sqlite3_bind_text (sqlite3_statement? exact-nonnegative-integer? string? . c-> . status?)]
 [sqlite3_bind_null (sqlite3_statement? exact-nonnegative-integer? . c-> . status?)]
 [sqlite3_bind_blob (sqlite3_statement? exact-nonnegative-integer? bytes? . c-> . status?)]
 [sqlite3_column_count (sqlite3_statement? . c-> . exact-nonnegative-integer?)]
 [sqlite3_column_name (sqlite3_statement? exact-nonnegative-integer? . c-> . string?)]
 [sqlite3_column_type (sqlite3_statement? exact-nonnegative-integer? . c-> . exact-nonnegative-integer?)]
 [sqlite3_column_decltype (sqlite3_statement? exact-nonnegative-integer? . c-> . (or/c string? false/c))]
 [sqlite3_column_blob (sqlite3_statement? exact-nonnegative-integer? . c-> . bytes?)]
 [sqlite3_column_text (sqlite3_statement? exact-nonnegative-integer? . c-> . string?)]
 [sqlite3_column_int64 (sqlite3_statement? exact-nonnegative-integer? . c-> . integer?)]
 [sqlite3_column_double (sqlite3_statement? exact-nonnegative-integer? . c-> . number?)]
 [sqlite3_reset (sqlite3_statement? . c-> . status?)]
 [sqlite3_finalize (sqlite3_statement? . c-> . status?)])